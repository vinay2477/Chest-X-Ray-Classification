...
sorted_x = list(
    reversed(sorted(val_counter.items(), key=operator.itemgetter(1))))
...
logging.info(
    "number of normal chest Images(healthy people) {}:".format(sorted_x[0][1]))
logging.info("number of abnormal chest Images(sick people) {}:".format(
    len(dic)-sorted_x[0][1]))
